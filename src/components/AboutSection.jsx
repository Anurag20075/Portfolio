...
//       <div className="text-2xl lg:text-3xl font-black text-white tabular-nums tracking-tight">
//         {value}
//       </div>
//       <div className="text-[11px] uppercase tracking-[0.15em] text-slate-500 font-medium mt-1">
//         {label}
//       </div>
//     </motion.div>
//   );
...
//       id="about"
//       ref={sectionRef}
//       className="relative py-32 px-6 bg-[#0B0F1A] text-slate-300 overflow-hidden"
//     >
//       {/* Background Orbs */}
//       <FloatingOrb className="w-96 h-96 bg-[#00C6D7]/[0.03] -top-48 -left-48" delay={0} />
//       <FloatingOrb className="w-80 h-80 bg-blue-600/[0.025] bottom-0 -right-40" delay={3} />
...
//         animate={isInView ? { pathLength: 1, opacity: 0.06 } : {}}
//         transition={{ duration: 2, ease: "easeInOut" }}
//         className="absolute top-0 left-0 w-full h-full pointer-events-none"
//       >
//         <svg className="w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="none">
//           <line x1="0" y1="800" x2="1200" y2="0" stroke="#00C6D7" strokeWidth="1" vectorEffect="non-scaling-stroke" />
//         </svg>
//       </motion.div>
...
//               style={{
//                 background: "linear-gradient(135deg, rgba(0,198,215,0.08), rgba(0,198,215,0.02))",
...
//                 border: "1px solid rgba(0,198,215,0.08)",
//               }}
//             />
...
//               className="absolute -top-8 right-8 md:right-16 w-4 h-4 rounded-sm bg-[#00C6D7]/30 -z-10"
//             />
//             <motion.div
//               animate={{ y: [0, 8, 0], opacity: [0.3, 0.7, 0.3] }}
//               transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
//               className="absolute -bottom-6 left-8 md:left-12 w-3 h-3 rounded-full bg-blue-500/30 -z-10"
//             />

//             {/* Main image container */}
//             <div className="relative group">
//               {/* Animated border glow */}
//               <div className="absolute -inset-[2px] rounded-2xl bg-gradient-to-br from-[#00C6D7]/20 via-transparent to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-[1px]" />

//               <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-2xl overflow-hidden shadow-2xl shadow-black/40">
//                 <motion.img
//                   src="pic.jpg"
//                   alt="Anurag Goyal"
...
//                 />
//                 <div className="absolute inset-0 bg-gradient-to-t from-[#0B0F1A] via-[#0B0F1A]/10 to-[#0B0F1A]/30" />

//                 {/* Scan line effect on hover */}
//                 <motion.div
//                   className="absolute left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[#00C6D7]/40 to-transparent opacity-0 group-hover:opacity-100"
//                   animate={{ top: ["0%", "100%"] }}
...
//                 className="absolute -bottom-4 -right-4 md:bottom-4 md:-right-8 flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#0B0F1A] border border-white/[0.08] shadow-xl shadow-black/30 backdrop-blur-sm"
//               >
//                 <motion.span
...
//                 <Code2 className="text-[#00C6D7]" size={16} />
//                 <span className="text-[#00C6D7] font-mono tracking-[0.2em] text-[11px] uppercase">
//                   Who I am
//                 </span>
//               </div>
//             </motion.div>
...
//               className="text-4xl md:text-5xl lg:text-[3.4rem] font-bold text-white mb-8 tracking-tight leading-[1.1]"
//             >
//               About{" "}
//               <span className="bg-gradient-to-r from-[#00C6D7] to-blue-400 bg-clip-text text-transparent">
//                 Me
//               </span>
//             </motion.h2>

//             {/* Paragraphs */}
//             <motion.p variants={textBlockVariants} className="text-[16px] leading-[1.8] mb-5 text-slate-300/80">
//               I'm{" "}
//               <span className="text-white font-semibold bg-white/[0.04] px-1.5 py-0.5 rounded">
//                 Anurag Goyal
//               </span>
...
//               <span className="text-[#00C6D7] font-medium">scalable, high-performance systems</span>{" "}
//               that solve real-world problems.
//             </motion.p>

//             <motion.p variants={textBlockVariants} className="text-[16px] leading-[1.8] mb-10 text-slate-300/80">
//               Whether I'm architecting RESTful APIs with{" "}
//               <span className="text-white/90 font-medium">Spring Boot</span> or crafting fluid user experiences in{" "}
//               <span className="text-white/90 font-medium">React</span>, I focus on clean code and maintainable architecture.
//             </motion.p>
...
//                 className="group/card flex items-start gap-4 p-5 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:border-[#00C6D7]/20 hover:bg-white/[0.05] transition-all duration-400"
//               >
//                 <div className="p-2.5 bg-[#00C6D7]/10 rounded-xl text-[#00C6D7] group-hover/card:bg-[#00C6D7]/15 transition-colors duration-300 flex-shrink-0">
//                   <GraduationCap size={22} />
//                 </div>
//                 <div>
//                   <h4 className="text-white font-bold text-sm mb-0.5">BCA Graduate</h4>
//                   <div className="flex items-center gap-1.5">
//                     <MapPin size={12} className="text-slate-500" />
//                     <p className="text-xs text-slate-500">Dr MPS Institute, Agra</p>
//                   </div>
//                 </div>
//               </motion.div>
...
//                 variants={cardVariants}
//                 whileHover={{ y: -4, transition: { duration: 0.25 } }}
//                 className="group/card flex items-start gap-4 p-5 rounded-xl bg-white/[0.03] border border-white/[0.06] hover:border-blue-400/20 hover:bg-white/[0.05] transition-all duration-400"
//               >
//                 <div className="p-2.5 bg-blue-500/10 rounded-xl text-blue-400 group-hover/card:bg-blue-500/15 transition-colors duration-300 flex-shrink-0">
//                   <Briefcase size={22} />
//                 </div>
//                 <div>
//                   <h4 className="text-white font-bold text-sm mb-0.5">Fresher</h4>
//                   <div className="flex items-center gap-1.5">
...
//                 whileTap={{ scale: 0.97 }}
//                 className="group/btn relative inline-flex items-center gap-3 px-8 py-4 bg-white text-[#0B0F1A] rounded-xl font-bold text-sm tracking-wide shadow-lg shadow-white/[0.05] overflow-hidden transition-shadow duration-500 hover:shadow-xl hover:shadow-white/[0.1]"
//               >
//                 {/* Shimmer sweep */}
//                 <span className="absolute inset-0 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/40 to-transparent" />
