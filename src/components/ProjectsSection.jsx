...
//         className="group relative bg-white/[0.03] border border-white/[0.06] rounded-2xl overflow-hidden hover:border-[#00C6D7]/30 transition-colors duration-500"
//       >
//         {children}
//       </motion.div>
//     );
...
//     <span className="absolute top-6 right-6 z-20 font-mono text-6xl font-black text-white/[0.04] select-none group-hover:text-[#00C6D7]/10 transition-colors duration-700">
//       {String(num).padStart(2, "0")}
//     </span>
//   );

//   return (
//     <section id="projects" className="relative py-32 px-6 bg-[#0B0F1A] overflow-hidden">
//       {/* Background Orbs */}
//       <FloatingOrb className="w-80 h-80 bg-[#00C6D7]/[0.04] -top-40 -left-40" delay={0} />
//       <FloatingOrb className="w-[500px] h-[500px] bg-blue-600/[0.03] top-1/3 -right-60" delay={3} />
//       <FloatingOrb className="w-72 h-72 bg-purple-600/[0.03] -bottom-32 left-1/4" delay={5} />
...
//       <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#00C6D7]/[0.03] rounded-full blur-[120px] pointer-events-none" />
...
//           >
//             <FolderCode className="text-[#00C6D7]" size={16} />
...
//           >
//             Featured{" "}
//             <span className="bg-gradient-to-r from-[#00C6D7] via-blue-400 to-[#00C6D7] bg-clip-text text-transparent bg-[length:200%_auto] animate-gradient-x">
//               Projects
//             </span>
//           </motion.h2>
...
//             whileInView="visible"
//             viewport={{ once: true }}
//             className="w-20 h-[3px] bg-gradient-to-r from-[#00C6D7] to-blue-500 mx-auto rounded-full origin-left"
//           />
//         </div>
...
//                 <div className="absolute inset-0 bg-gradient-to-t from-[#0B0F1A] via-[#0B0F1A]/50 to-[#0B0F1A]/20" />

//                 {/* Hover overlay */}
//                 <div className="absolute inset-0 bg-[#00C6D7]/[0.05] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
...
//                     whileHover={{ scale: 1.1 }}
//                     whileTap={{ scale: 0.95 }}
//                     className="p-3.5 bg-white/10 backdrop-blur-md border border-white/20 text-white rounded-xl hover:bg-[#00C6D7]/20 hover:border-[#00C6D7]/40 transition-all duration-300 shadow-lg shadow-black/20"
//                   >
//                     <Github size={20} />
//                   </motion.a>
//                   <motion.a
...
//                 <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00C6D7]/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
//               </div>
...
//                       className="text-[10px] uppercase tracking-[0.15em] font-bold px-2.5 py-1 bg-[#00C6D7]/[0.08] text-[#00C6D7]/80 rounded-md border border-[#00C6D7]/10 hover:border-[#00C6D7]/30 hover:text-[#00C6D7] transition-colors duration-300 cursor-default"
//                     >
//                       {t}
//                     </motion.span>
//                   ))}
...
//                 {/* Title */}
//                 <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 group-hover:text-[#00C6D7] transition-colors duration-500 flex items-center gap-2">
//                   {project.title}
//                   <ArrowUpRight
...
//                 {/* Description */}
//                 <p className="text-slate-400/80 leading-relaxed text-sm lg:text-[15px]">
//                   {project.desc}
//                 </p>
//               </div>
...
//                 <div className="absolute top-3 left-3 w-4 h-[1px] bg-[#00C6D7]/0 group-hover:bg-[#00C6D7]/40 transition-colors duration-700" />
//                 <div className="absolute top-3 left-3 w-[1px] h-4 bg-[#00C6D7]/0 group-hover:bg-[#00C6D7]/40 transition-colors duration-700" />
//               </div>

//               {/* Corner accent — bottom right */}
//               <div className="absolute bottom-0 right-0 w-16 h-16 pointer-events-none">
//                 <div className="absolute bottom-3 right-3 w-4 h-[1px] bg-[#00C6D7]/0 group-hover:bg-[#00C6D7]/40 transition-colors duration-700" />
//                 <div className="absolute bottom-3 right-3 w-[1px] h-4 bg-[#00C6D7]/0 group-hover:bg-[#00C6D7]/40 transition-colors duration-700" />
//               </div>
//             </TiltCard>
//           ))}
//         </motion.div>
...
//             whileTap={{ scale: 0.98 }}
//             className="group/cta relative inline-flex items-center gap-3 px-8 py-4 rounded-xl border border-white/[0.08] bg-white/[0.03] text-white font-semibold text-sm tracking-wide hover:border-[#00C6D7]/30 hover:bg-white/[0.05] transition-all duration-500 overflow-hidden"
//           >
//             {/* Shimmer sweep on hover */}
//             <span className="absolute inset-0 -translate-x-full group-hover/cta:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-[#00C6D7]/10 to-transparent" />
