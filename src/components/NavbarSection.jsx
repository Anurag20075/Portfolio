...
//         ? "bg-[#0B0F1A]/80 backdrop-blur-lg border-b border-white/10 py-3"
//         : "bg-transparent py-5"
//         }`}
//     >
...
//           >
//             <span className="text-[#00C6D7]">Anurag</span>
//             <span className="text-slate-300">Goyal</span>
//           </motion.a>
...
//                 className="relative group text-sm font-medium text-slate-400 hover:text-white transition-colors"
//               >
//                 {text}
//                 {/* Animated Underline */}
//                 <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#00C6D7] transition-all duration-300 group-hover:w-full" />
//               </a>
//             ))}

//             {/* CTA Button */}
//             <button className="px-5 py-2 rounded-full bg-[#00C6D7] text-[#0B0F1A] font-bold text-sm hover:bg-[#00e2f5] hover:shadow-[0_0_15px_rgba(0,198,215,0.4)] transition-all">
//               Resume
//             </button>
//           </div>
...
//                   className="text-lg font-medium text-slate-300 hover:text-[#00C6D7] transition-colors"
//                 >
//                   {text}
//                 </a>
//               ))}
